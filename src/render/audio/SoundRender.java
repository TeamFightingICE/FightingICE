...
public class SoundRender {
    ...
    public void playback(int sourceId, byte[] audioSample) {
        ...
        if (getProcessedBuffers(sourceId) > 0) {
    ...
    public void stopPlayback(int sourceId) {
    	...
    	int processedBuffers = getProcessedBuffers(sourceId);
