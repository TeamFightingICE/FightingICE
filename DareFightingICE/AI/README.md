# <div align="center"> 2026 DareFightingICE LLM AI Competition</div>
----
...
[![Watch the video](./Logo.png)](https://www.youtube.com/playlist?list=PLwrbb0kRyPsmYXHZQ9Lp9oeTSIHYvrQDY)

### Instruction on how to run the platform:
---
1. Download DareFightingICE from this [link](https://github.com/TeamFightingICE/FightingICE/releases) along with the resource files given in a note. (latest version 7.0).
