...
---
1. Download DareFightingICE from this [link](https://github.com/TeamFightingICE/FightingICE/releases) along with the resource files given in a note. (latest version 7.0beta).
